...
public class CTRESwerve extends SwerveDrivetrain {
    ...
    private final SwerveSpeedConstants swerveSpeedConstants;
     ...
     */
    public CTRESwerve(SwerveDrivetrainConstants driveTrainConstants, SwerveSpeedConstants speedConstants, SwerveModuleConstantsFactory commonModuleConstants, SwerveModuleConstants... moduleConstants) {
        ...
        this.swerveSpeedConstants = speedConstants;
    }
     ...
     */
    public void resetHeading(Rotation2d currentGyroscopeRotationOffset){
        this.setGyroscopeYaw(currentGyroscopeRotationOffset);
    ...
    public void startSimThread() {
        ...
        m_simNotifier.startPeriodic(swerveSpeedConstants.SIMULATION_LOOP_PERIOD);
    }
